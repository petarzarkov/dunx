...
| [`@dunx/db`](./packages/db) | [![npm](https://img.shields.io/npm/v/%40dunx%2Fdb)](https://www.npmjs.com/package/%40dunx%2Fdb) [![dls](https://img.shields.io/npm/dt/%40dunx%2Fdb?label=dls)](https://www.npmjs.com/package/%40dunx%2Fdb) [![size](https://img.shields.io/npm/unpacked-size/%40dunx%2Fdb?label=size)](https://www.npmjs.com/package/%40dunx%2Fdb) | [![cov](https://petarzarkov.github.io/dunx/coverage-db.svg)](https://petarzarkov.github.io/dunx#db) | SQL and SQLite access built on Bun.SQL and bun:sqlite |
| [`@dunx/files`](./packages/files) | [![npm](https://img.shields.io/npm/v/%40dunx%2Ffiles)](https://www.npmjs.com/package/%40dunx%2Ffiles) [![dls](https://img.shields.io/npm/dt/%40dunx%2Ffiles?label=dls)](https://www.npmjs.com/package/%40dunx%2Ffiles) [![size](https://img.shields.io/npm/unpacked-size/%40dunx%2Ffiles?label=size)](https://www.npmjs.com/package/%40dunx%2Ffiles) | [![cov](https://petarzarkov.github.io/dunx/coverage-files.svg)](https://petarzarkov.github.io/dunx#files) | Local and S3 storage built on Bun.file, Bun.write, Bun.Glob and Bun.S3Client |
...
| [`@dunx/images`](./packages/images) | [![npm](https://img.shields.io/npm/v/%40dunx%2Fimages)](https://www.npmjs.com/package/%40dunx%2Fimages) [![dls](https://img.shields.io/npm/dt/%40dunx%2Fimages?label=dls)](https://www.npmjs.com/package/%40dunx%2Fimages) [![size](https://img.shields.io/npm/unpacked-size/%40dunx%2Fimages?label=size)](https://www.npmjs.com/package/%40dunx%2Fimages) | [![cov](https://petarzarkov.github.io/dunx/coverage-images.svg)](https://petarzarkov.github.io/dunx#images) | Image decoding and transformation built on Bun.Image |
| [`@dunx/redis`](./packages/redis) | [![npm](https://img.shields.io/npm/v/%40dunx%2Fredis)](https://www.npmjs.com/package/%40dunx%2Fredis) [![dls](https://img.shields.io/npm/dt/%40dunx%2Fredis?label=dls)](https://www.npmjs.com/package/%40dunx%2Fredis) [![size](https://img.shields.io/npm/unpacked-size/%40dunx%2Fredis?label=size)](https://www.npmjs.com/package/%40dunx%2Fredis) | [![cov](https://petarzarkov.github.io/dunx/coverage-redis.svg)](https://petarzarkov.github.io/dunx#redis) | Redis/Valkey client built on Bun.RedisClient |
| [`@dunx/ws`](./packages/ws) | [![npm](https://img.shields.io/npm/v/%40dunx%2Fws)](https://www.npmjs.com/package/%40dunx%2Fws) [![dls](https://img.shields.io/npm/dt/%40dunx%2Fws?label=dls)](https://www.npmjs.com/package/%40dunx%2Fws) [![size](https://img.shields.io/npm/unpacked-size/%40dunx%2Fws?label=size)](https://www.npmjs.com/package/%40dunx%2Fws) | [![cov](https://petarzarkov.github.io/dunx/coverage-ws.svg)](https://petarzarkov.github.io/dunx#ws) | WebSocket server and client built on Bun.serve and the native WebSocket |
...
│   ├── db              # SQL and SQLite access built on Bun.SQL and bun:sqlite
│   ├── files           # Local and S3 storage built on Bun.file, Bun.write, Bun.Glob and Bun.S3Client
│   ├── http            # Bun.serve adapter for the dunx framework
│   ├── images          # Image decoding and transformation built on Bun.Image
│   ├── redis           # Redis/Valkey client built on Bun.RedisClient
│   └── ws              # WebSocket server and client built on Bun.serve and the native WebSocket
