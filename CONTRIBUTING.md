...
`bench` (the benchmark harness), `dashboard-ui` (the React
...
│   └── mcp             # A Model Context Protocol server for dunx - the written guide and scaffold catalogue with no app, your routes and providers with one
