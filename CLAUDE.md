...
tree-shaking earns its 1.8 s. Its build writes `packages/openapi/src/ui-bundle.ts`
— generated, committed, and regenerated by `packages/openapi`'s own `build` so it
