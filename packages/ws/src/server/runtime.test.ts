...
import { Gateway, OnMessage, OnOpen } from '../gateway/decorators.js';
import { discoverGateway } from '../gateway/discover.js';
...
describe('buildGateways()', () => {
  ...
  it('throws when nothing was registered', () => {
    expect(() => buildGateways([])).toThrow('No gateways were registered');
  });
});
