        ...
        <Group gap="xs" align="flex-start" wrap="nowrap">
          ...
          <Text size="sm" c="dimmed" maw={720}>
            {speed.crossesRuntime
              ? `Colour encodes the runtime. dunx runs on Bun and every subject in the headline runs on Node, so each multiple combines a runtime difference with a framework difference. Two comparisons isolate the framework: the DI subjects against their own adapters, and dunx against raw Bun.serve, where it costs ${decimal(ownCost, 1)}%.`
